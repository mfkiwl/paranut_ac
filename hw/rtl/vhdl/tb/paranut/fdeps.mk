...
$(ENTITY_NAME)_tb.o: paranut_config.o types.o paranut.o peripherals.o prog_mem.o tb_monitor.o

peripherals.o: types.o
wb_memory.o: paranut_config.o types.o paranut_lib.o text_io.o txt_util.o
prog_mem.o: types.o
wb_uart.o: paranut_config.o types.o paranut_lib.o text_io.o txt_util.o
