...
PORT_CFLAGS = -O3 -mhard-mul -msoft-div -msoft-float
FLAGS_STR = "$(PORT_CFLAGS) $(XCFLAGS) $(XLFLAGS) $(LFLAGS_END)"
CFLAGS = $(PORT_CFLAGS) -I$(PORT_DIR) -I. -DFLAGS_STR=\"$(FLAGS_STR)\" -I../../drivers/counter/include -I../../drivers/paranut/include
#Flag: LFLAGS_END
#	Define any libraries needed for linking or other flags that should come at the end of the link line (e.g. linker scripts). 
#	Note: On certain platforms, the default clock_gettime implementation is supported but requires linking of librt.
LFLAGS_END += -mnewlib -mboard=or1ksim #-T$(PORT_DIR)/core_portme.ld
# Flag: PORT_SRCS
# Port specific source files can be added here
PORT_SRCS = $(PORT_DIR)/core_portme.c ../../drivers/counter/counter.c ../../drivers/paranut/paranut_hist.c ../../drivers/paranut/paranut.c
# Flag: LOAD
...
PORT_OBJS = $(PORT_DIR)/core_portme$(OEXT) $(PORT_DIR)/mystart$(OEXT)
PORT_CLEAN = *$(OEXT)
